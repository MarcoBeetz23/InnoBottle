...
// WiFi constants
#define WIFI_SSID "iPhone von Julia"
#define WIFI_PASSWORD "09idnqrjdw2be"
...
void loop(){
    ...
    String filename = "/loadCells" + String(i) + ".csv";
    ...
    if(currentState == "ready"){
      ...
      if(readyAgain == true) {
        i = i+1;
        filename = "/loadCells" + String(i) + ".csv";
      }
      readyAgain = false;
    }
    ...
    if(currentState == "active"){
      ...
      //sd card
      String dataString = String(loadCellValues[0]) + ", " + String(loadCellValues[1]) + ", " + String(loadCellValues[2]) + ", " + String(loadCellValues[3]) + ", " + String(loadCellValues[4]) + ", " + String(loadCellValues[5]) + ", " + String(loadCellValues[6]) + ", " + String(loadCellValues[7]) + ", " + String(loadCellValues[8]) + ", " + String(timedelta);
